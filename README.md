...
**VitalIS** este un ecosistem digital inovator conceput pentru a decongestiona Unitățile de Primiri Urgențe (UPU) și a eficientiza triajul medical folosind Inteligența Artificială și modele matematice de probabilitate. 
...
VitalIS rezolvă această problemă printr-o abordare hibridă (AI + Matematică) și este structurat în 3 module interconectate în timp real:
...
## ⚙️ Arhitectură și Pipeline Tehnic

Sistemul nostru NU lasă un simplu chatbot să pună diagnostice, ci folosește un sistem de **Safe Over-Triage**:
...
* **Triage Engine:** Simptomele sunt introduse într-un motor de probabilități matematice bazat pe **Teorema lui Naive Bayes**, care calculează scorul de gravitate corelând simptomele cu istoricul medical al pacientului.
* **Sincronizare:** Decizia este trimisă instantaneu către spital prin **Firebase Firestore**.
...
* **Bază de date & Backend:** Firebase Firestore, Firebase Authentication
